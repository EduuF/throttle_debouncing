def check_stop_word(search_queue: str) -> bool:
    stop_word = ['i', 'me', 'my', 'myself', 'we', 'our', 'ours', 
    ...
    for word in search_queue:
        if word in stop_word:
            print(f"TRUE! Stop word: {word}")
        else:
            print(f"FALSE!Not stop word: {word}")
    return True